    ...
    <section className="relative min-h-[870px] flex items-center overflow-hidden bg-white">
      <div className="container mx-auto px-6 lg:px-[120px] py-16 lg:py-[120px] grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="z-10 max-w-2xl">
          <h1 className="font-display font-bold text-[40px] lg:text-[56px] leading-[1.2] lg:tracking-[-0.02em] text-[#1E1B2E] mb-6">
            Caring for your smile, right opposite Victoria Station
          </h1>
          <p className="font-body text-[20px] leading-[1.6] mb-10 text-[#494551]">
            Friendly NHS and private dental care, with same-day emergency
            appointments for when you need us most.
          </p>
        ...
        {/* Right: Image with hours overlay */}
        <div className="relative">
          <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl relative">
            ...
            <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md p-6 rounded-xl shadow-xl border border-[#F4F1FA]">
              <h3 className="font-display font-semibold text-[28px] leading-[1.4] text-[#1E1B2E] mb-3">
                Today&apos;s Hours
              </h3>
              <div className="flex justify-between items-center text-[#494551] font-semibold text-[16px]">
                <span>Mon - Fri</span>
