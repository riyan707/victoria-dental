  ...
  return (
    <section className="py-[120px] bg-white">
      <div className="max-w-[1200px] mx-auto px-6 grid lg:grid-cols-2 gap-20">
        {/* Left: Info */}
        <div>
          <h2 className="font-display font-bold text-[40px] leading-[1.2] text-[#1E1B2E] mb-10">
            Find us in Victoria
          </h2>
          <div className="space-y-8">
            {/* Address */}
            <div className="flex gap-4">
              <span className="material-symbols-outlined text-[#432587] flex-shrink-0">location_on</span>
              <div>
                <h4 className="font-body font-semibold text-lg text-[#1E1B2E]">Address</h4>
            ...
            {/* Hours */}
            <div className="flex gap-4">
              <span className="material-symbols-outlined text-[#432587] flex-shrink-0">schedule</span>
              <div className="w-full">
                <h4 className="font-body font-semibold text-lg text-[#1E1B2E] mb-4">Opening Hours</h4>
                <table className="w-full">
                  <tbody>
                    {hours.map(({ day, time }) => (
                      <tr key={day} className="border-b border-[#F4F1FA] last:border-0">
                        <td className="py-2 font-body text-[18px] text-[#494551]">{day}</td>
                        <td className="py-2 font-bold text-right text-[#1E1B2E] font-body text-[18px]">{time}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <a
                ...
                className="bg-[#5b3fa0] text-white min-h-[56px] px-8 rounded-full font-semibold text-[16px] btn-hover shadow-md flex items-center justify-center gap-2"
              >
                <span className="material-symbols-outlined">call</span>
                020 7834 6161
              </a>
              <button className="bg-[#F4F1FA] text-[#432587] min-h-[56px] px-8 rounded-full font-semibold text-[16px] btn-hover flex items-center justify-center gap-2">
        ...
        <div className="rounded-2xl overflow-hidden soft-shadow h-[500px] relative bg-slate-200">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3 border border-[#432587]/20">
              <span className="material-symbols-outlined text-[#432587] text-3xl" style={{fontVariationSettings:"'FILL' 1"}}>location_on</span>
              <div>
